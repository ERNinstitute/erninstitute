...
## Permanent research-tool URLs — September 09, 2026

- Research Tools hub: `https://erninstitute.com/tools/`
- Meta-Analysis Studio: `https://erninstitute.com/tools/meta-analysis-studio/`
- Legacy `/tools.html` is retained as a compatibility redirect to the Studio.
- The Studio was moved from the current repository file rather than reconstructed, preserving the latest functionality.
